...
SPEAKER_CONTEXT = "This is a conversation between Harrison Ford and Rachel Martin"
ENABLE_DIARIZATION = True
...
const SPEAKER_CONTEXT = "This is a conversation between Harrison Ford and Rachel Martin";
const DIARIZE = true;
const wait = (ms: number) => new Promise((r) => setTimeout(r, ms));
