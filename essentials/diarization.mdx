...
BASE_URL = "https://api.fennec-asr.com/api/v1"
API_KEY = "YOUR_API_KEY_HERE"
AUDIO_URL = "https://s3.amazonaws.com/static.simon.com/educator-in-chief/audio/chapter-1.mp3"
...
const url =
  process.argv[2] ||
  "https://s3.amazonaws.com/static.simon.com/educator-in-chief/audio/chapter-1.mp3";
